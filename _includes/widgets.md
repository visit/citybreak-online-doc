...
| tripType	 | String | oneway (or roundtrip) |Set selected trip type onload return (default) OR oneway, only work for iticket product with a trip type as option of course.  |
